...
/**
 * This utility class defines a way of creating and propagating universal events, without having to explicitly specify
 * custom event listeners everytime.
 *
 * @param <T>
 *            the payload that an event carries. If not payload should be carried, the internal class
...
public class EventManager<T> {
     ...
     *
     * @param name
     *            the name of the event mananger.
     */
    ...
    /**
     * Remove the supplied listener from this event manager, i.e. future events will not be dispatched via the supplied
     * listener.
     *
     * @param listener
     *            the handler which will be removed.
     * @return a reference to <tt>this</tt> for chainability convenience
     */
    ...
    /**
     * Dispatch a new event with the given payload. All registered listeners will trigger with the supplied payload.
     *
     * @param payload
    ...
    /**
     * Attach a different event manager to this one, i.e. everytime the other supplied event manager fires, the event
     * will be propagated to all listeners of this event manager.
     *
     * @param otherEventManager
     *            the other event manager whose events will be propagated to listeners of this manager.
     */
